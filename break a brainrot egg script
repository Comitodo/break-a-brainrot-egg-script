...
local Window = Rayfield:CreateWindow({
   Name = "🥚 New Break a Brainrot Egg | Skyming Anubissxxxx",
...
local EggsTab = Window:CreateTab("🥚 Eggs TP", 4483362458)
local PvPTab = Window:CreateTab("⚔️ PvP Damage", 4483362458)
local VisualsTab = Window:CreateTab("👁️ ESP", 4483362458)
...
-- ====================================================
-- AUTO MONEY (BaseA/B/D → Platforms → Platforms_1 → Collect)
-- ====================================================
...
EggsTab:CreateToggle({
   Name = "Auto TP al Egg más cercano",
   CurrentValue = false,
   Flag = "AutoTPEggs",
   Callback = function(Value)
...
EggsTab:CreateSlider({
   Name = "Distancia máxima Auto TP Eggs",
   Range = {50, 1000},
   Increment = 50,
   CurrentValue = 400,
   Flag = "AutoTPDistEgg",
...
EggsTab:CreateButton({
   Name = "TP Manual al Egg más cercano",
   Callback = function()
      tpToNearestEgg()
      Rayfield:Notify({Title = "TP Manual", Content = "¡Al egg más cercano!", Duration = 3})
   end,
})
...
PvPTab:CreateSlider({
   Name = "Distancia máxima para atacar",
   Range = {10, 300},
   Increment = 10,
   CurrentValue = 80,
   Flag = "PvPDist",
...
print("✅ FULL HUB + PvP Cargado: Todo incluido")
